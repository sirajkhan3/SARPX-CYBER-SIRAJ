...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "mou")) {
  ...
  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "vutu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সিরাজ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@ཐི༏ཋྀMagibaz卝Miraj一ཐི༏ཋྀ࿐: ") || (event.body.toLowerCase() == "সিয়াম")) {
